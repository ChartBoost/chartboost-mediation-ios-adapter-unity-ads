...
@objc public class UnityAdsAdapterConfiguration: NSObject, PartnerAdapterConfiguration {
    ...
    @objc public static let adapterVersion = "5.4.16.0.0"
    ...
    /// Internal flag that indicates if the Privacy consent has been overridden by the publisher.
    private(set) static var isPrivacyConsentOverridden = false
}
